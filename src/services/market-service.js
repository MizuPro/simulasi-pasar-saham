...
class MarketService {
            ...
            for (const stock of stocks.rows) {
                try {
                    ...
                    if (trades.length > 0) {
                        ...
                        if (((_a = lastCandle === null || lastCandle === void 0 ? void 0 : lastCandle.rowCount) !== null && _a !== void 0 ? _a : 0) > 0) {
    ...
    static async aggregateCandles(client) {
        try {
            const timeframes = [
                { name: '5m', minutes: 5 },
                { name: '15m', minutes: 15 },
    ...
    static async getOrderQueue(symbol, price) {
        ...
        const parseAndSort = (raw, side) => {
            const orders = raw.map(str => {
                ...
                try {
                    ...
                    return {
                        ...
                        remaining_quantity: (_a = data.remaining_quantity) !== null && _a !== void 0 ? _a : data.quantity,
            ...
            return orders.sort((a, b) => ((a === null || a === void 0 ? void 0 : a.timestamp) || 0) - ((b === null || b === void 0 ? void 0 : b.timestamp) || 0));
        };
